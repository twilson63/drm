...
export default () => (
  <Layout>
    ...
    <main class="max-w-5xl mx-auto">
      ...
      <form hx-post="/api/devs" hx-ext="json-enc">
        <div class="form-control">
          <label class="label" for="handle">
            <span class="label-text">Handle</span>
          </label>
          <input class="input input-bordered" type="text" id="handle" name="handle" required />
        </div>
        <div class="form-control">
          <label class="label" for="fullname">
            <span class="label-text">Fullname</span>
          </label>
          <input id="fullname" name="fullname" class="input input-bordered" type="text" />
        </div>
        <div class="form-control">
          <label class="label" for="bio">
            <span class="label-text">Bio</span>
          </label>
          <textarea id="bio" name="bio" class="textarea h24 textarea-bordered"></textarea>
        </div>
